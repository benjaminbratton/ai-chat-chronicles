        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-1 hover:text-pink-500 transition-colors"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-1 hover:text-orange-500 transition-colors"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-1 hover:text-blue-700 transition-colors"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-1 hover:text-green-500 transition-colors"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-1 hover:text-indigo-500 transition-colors"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-text-1 hover:text-green-400 transition-colors"
            >
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <Link to="/" className="flex items-center space-x-3">
              <h1 className="text-2xl font-bold tracking-tight brand">
                polylogos<span className="dot">.</span>
              </h1>
            </Link>
          </div>

          {/* Navigation */}
          <nav className="hidden md:flex items-center space-x-6 ml-16 nav">
            <Link 
              to="/" 
          ...
          <div className="flex-1 max-w-md mx-8">
            <div className="relative search">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 icon" />
              <input
                type="search"
                ...
                className="w-full pl-10 pr-4 py-2 pill"
              />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            {loading ? (
              <div className="w-8 h-8 bg-text-dim rounded-full animate-pulse"></div>
            ) : user ? (
              <UserMenu />
            ) : (
              <AuthButtons />
